      ...
      >
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <p className="text-sm text-light-muted dark:text-dark-muted leading-relaxed">
            ...
            Trakteer supaya dmrxai tetap gratis dan bisa terus diakses. Setiap bantuan dari kalian sangat berarti dan saya sangat berterima kasih atas supportnya, orang-orang baik 💖
          </p>
